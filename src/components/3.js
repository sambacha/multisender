      ...
      <div className="container container_bg">
        <div className="content">
          ...
          <p className="description">
            ...
            This Dapp supports Mainnet, POA-Core, POA-sokol, Ropsten, Rinkeby,
            Kovan
          </p>
          <form className="form">
            <ReactJson
            ...
            <div className="send-info">
              <div className="send-info-side">
                ...
                <div className="send-info-i">
                  <p>Your Balance</p>
                  <p className="send-info-amount">
                    {this.tokenStore.defAccTokenBalance}{' '}
            ...
            <Link onClick={this.onNext} className="button button_next" to="/4">
              Next
            </Link>
          </form>
        </div>

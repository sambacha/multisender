...
module.exports = async function (deployer, network, accounts) {
    ...
    if (network === "mainnet") {
        ...
        const token_cotract = await inchTestsToken.deployed();
        tokenAddress = token_cotract.address;
    }
    ...
    // let balances = [12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12].map(x => x*2);
    let balances = [12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12];
    console.log(accounts[0])
    const SENDER = accounts[0];
    const SENDED_VALUE = Math.sum(balances);
    console.log(SENDED_VALUE)
    // const SENDED_VALUE = balances.reduce((a,b) => a+b, 0) * 2;
    ...
    i = await inchTestsToken.deployed()
    b = await i.balanceOf("0xf2D8337F7D1E8Fa9b913068B52B72Cd31D84733A")
